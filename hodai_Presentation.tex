...
\def\AutoCarComp{
    ...
    \node[state,initial,accepting](s0) at (2.46,2.6){s0};
    \node[state,accepting](s1) at (3.5,4.42){s1};
    \node[state,accepting](s2) at (5.6,4.42){s2};
    \node[state,accepting](s3) at (6.66,2.6){s3};
    \node[state,accepting](s4) at (5.6,0.8){s4};
    \node[state,accepting](s5) at (3.5,0.8){s5};
    \path[->]
...
\def\AutoCarObsGameBased{
    \todoil{TODO: actual automata of obstacle avoidance component}
}
\frame{
...
\frame{
    ...
    \end{block}
    \textbf{Q: How to create the guarded automata?}
        By wining \buchi games
}
