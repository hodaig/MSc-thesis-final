...
\frame{
    ...
    \begin{center}
        \includegraphics[width=90mm]{SimulinkModel}
    \end{center}
    \begin{block}{}
        \begin{itemize}
            \item Unit variance process \& actuation noise
            \item High sensing mode variance 0.25
            \item Low sensing mode variance 1
        \end{itemize}
    \end{block}
}
\frame{
