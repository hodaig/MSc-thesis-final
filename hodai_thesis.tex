...
\subsection{Option 1: Intro From Paper}
...
\subsection{Option 2: Motivation and Overview}
...
\label{sec:Problem}
We are concentrate on feedback control loop based systems as shown in Figure~\ref{fig:control loop}. 
