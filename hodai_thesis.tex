...
%TODO Hodai: mybe add the simucopter project
...
\todo{hey, please read this subsection, I added the detailed explanation of our Kalman filter technique}
...
%, see Section~\ref{sec:kalman} for Kalman-filter characteristics. 
...
\todoil{use the wiki notations (change $\hat{x}_k^-$ to $\hat{x}_{k|k-1}$) and so on}
\label{sec:kalman}
...
\commentOut{
    %TODO - consider using parts from here to the vision part of "experiment setup" or "state estimator"
