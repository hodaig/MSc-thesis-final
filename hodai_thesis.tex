...
%There was many other researches proposing automata-based interfaces~\cite{many, Towards Robustness for Cyber-Physical Systems} and LTI~\cite{many} and ...
...
% TODO GERA: Say that Hanoch did not do online control. How did we improve on Hanoch work?
...
Clearly, for run-time adaptation, it doesn't make sense to apply an solver that finds and optimal schedule if it takes more CPU than it saves. In our work, we show that automata based scheduling, which does not require any significant run-time computations, can serve for this purpose.
